...
(cl-defmethod gp--approve-pr ((_ git-platform-bitbucket) full-name id &optional unapprove)
  (bitbucket-approve-pr full-name id unapprove))
(cl-defmethod gp--request-changes-pr ((_ git-platform-bitbucket) full-name id &optional unrequest)
